...
from gear_sonic_sim.network_utils import resolve_interface
...
class BaseConfig(ArgsConfigTemplate):
    ...
    def load_wbc_yaml(self) -> dict:
        ...
        # VENDOR PATCH: in the standalone bundle the wbc configs sit at
        # sim/wbc_configs/, beside this package, not under gear_sonic/utils/.
        configs_dir = Path(__file__).resolve().parent.parent / "wbc_configs"
